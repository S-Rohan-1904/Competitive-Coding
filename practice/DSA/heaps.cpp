...
private:
    ...
    void heapifyUp(int idx) {
        // compare with its parent and keep going using heap invariant is not satisfied
    ...
    void heapifyDown(int idx) {
        ...
        while(2 * idx <= sz) {
            ...
            // if the largest is same as the current index then heap invariant is satisfied
            if(largest == idx) return;

            // otherwise swap and change idx to largest
