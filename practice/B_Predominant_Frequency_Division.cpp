...
const int MOD = 1e9 + 7;
const int INF = 1e9 + 1;
//  left part the number of ones is at least the total number of twos and threes, 
...
// 1 >= 2 + 3, 1 + 2 >= 3, non empty

/*
2 1 1 3 3 1 2 3
[2,1,1,3], [3,1,2], and [3]
what if we put all 1's then all 2's then all 3's
1,1,1, 2,2, 3,3,3
we have x ones we need to split it
we will put 3's in the last partition
