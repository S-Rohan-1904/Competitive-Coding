...
We can always do it in 2 moves -> choose the entire array twice
If the array doesn't contain a zero then the ans is always 1
...
Ok so we need to make a range such that it doesn't contain 
we don;t care abt traling and leading zeros,

the ans is number of contiguous non zero elements
*/
