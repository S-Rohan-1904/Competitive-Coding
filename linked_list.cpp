...
/*
The 5 Golden Rules of Raw Pointers

1. The "Empty Railyard" Rule (head == nullptr)

2. The Conductor Rule (Head Check)

3. The Caboose Rule (Tail Check)

4. The "Lone Car" Rule (head == tail)

5. The Connection Rule (New to Old, Old to New)
*/
